   ...
   <nav class="main-nav">
       <div class="container container--flex">
           ...
           <ul class="menu" id="menu">
               ...
               <li class="menu__item"><a href="categorias.php" class="menu__link menu__link--select">Categorias</a></li>
    ...
    <main class="main">
        <section class="group">
            <div class="container container--flex">
                   <h3 class="group__title">Categorias</h3>
            </div>
        </section>
    </main>  
    <div class="container container--flex">
       <div class="column column--51">
        <a href="registrar_Categoria.html" class="btn btn--contact">Registrar</a>
        </div>
    </div>
            <div class="container container--flex registro__platos">        
                  <div class="column column--25">
                   <h3 class="column__title">N° Categoria</h3>
                   </div>
                  <div class="column column--25"> 
...
while($row = mysqli_fetch_assoc($resultado)){?>            
            <div class="container container--flex registro__platos">        
                  <span class="container container--flex registro__platos slec" id="btnOpciones2">
                       <div class="column column--25">
                       <p class="column__txt"><?php echo $row ["id_categoria"];?></p>
                       </div>
                       <div class="column column--25"> 
                       <p class="column__txt"><?php echo $row ["nombre_categoria"];?></p>
                       </div>
                       <div class="column column--25"> 
                       <p class="column__txt"><?php echo $row ["descripcion_categoria"];?></p>
                       </div>
                       <div class="column column--25"> 
                       <a href="editar_categoria.php?id_categoria=<?php echo $row["id_categoria"]; ?>" class="social-icon__link"><span class="icon-modi" ></span></a> 
                       <a href="php/eliminar_categoria.php?id_categoria=<?php echo $row["id_categoria"]; ?>" class="social-icon__link"><span class="icon-delete" ></span></a> 
                       </div>
                   </span>
            </div> 
<?php }?> 
