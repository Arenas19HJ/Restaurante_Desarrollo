<?php
include("php/cn.php");
$trazado ="SELECT id_pedido,cocinero,repartidor,temperatura,descripcion_pedido FROM pedido WHERE cocinero is not null";
?>
...
<body>
   ...
   <nav class="main-nav">
    ...
    <main class="main">
        <section class="group">
            <div class="container container--flex">
                   <h3 class="group__title">Trazado de pedidos</h3>
            </div>
        </section>
    </main>  
    <div class="container container--flex">
       <div class="column column--51">
        <a href="registrar_Trazado.html" class="btn btn--contact">Registrar</a>
        </div>
    </div>
            <div class="container container--flex registro__platos" enctype="multipart/form-data">        
                  <div class="column column--16">
                   <h3 class="column__title">ID Pedido</h3>
                   </div>
                   <div class="column column--16"> 
                   <h3 class="column__title">Descripcion</h3>
                   </div>
                  <div class="column column--16"> 
                   <h3 class="column__title">Cocinero(s)</h3>
                   </div>
                   <div class="column column--16"> 
                   <h3 class="column__title">Repartidor</h3>
                   </div>
                   <div class="column column--16"> 
                   <h3 class="column__title">Temperatura</h3>
                   </div>
                   <div class="column column--16">  
                   <h3 class="column__title">acciones</h3>
                   </div>     
            </div> 
<?php $resultado = mysqli_query($conexion, $trazado);
...
while($row = mysqli_fetch_assoc($resultado)){?>
            <div class="container container--flex registro__platos">        
                  <span class="container container--flex registro__platos slec" id="btnOpciones2">
                       <div class="column column--16">
                       <p class="column__txt"><?php echo $row ["id_pedido"];?></p>
                       </div>
                       <div class="column column--16">
                       <p class="column__txt"><?php echo $row ["descripcion_pedido"];?></p>
                       </div>
                       <div class="column column--16"> 
                       <p class="column__txt"><?php echo $row ["cocinero"];?></p>
                       </div>
                       <div class="column column--16">
                       <p class="column__txt"><?php echo $row ["repartidor"];?></p>
                       </div>
                       <div class="column column--16">
                       <p class="column__txt"><?php echo $row ["temperatura"];?></p>
                       </div>
                       
                        
                       <div class="column column--16"> 
                       <a href="editar_trazado.php?id_pedido=<?php echo $row["id_pedido"]; ?>" class="social-icon__link"><span class="icon-modi" ></span></a>  
                       </div>
                   </span>
            </div> 
<?php }?> 
