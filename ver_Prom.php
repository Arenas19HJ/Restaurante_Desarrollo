...
$plato ="SELECT cola.id_promocion,nombre,precio,descripcion FROM plato JOIN cola ON plato.id_plato=cola.id_plato WHERE cola.id_promocion= '$id_promocion'";
?>
   ...
   <nav class="main-nav">
    ...
    <div class="container container--flex">
       <div class="column column--51">
        <a href="promociones.php" class="btn btn--contact">Volver</a>
        </div>
    </div>
