...
<body>
   ...
   <nav class="main-nav">
    ...
    <main class="main">
        <section class="group">
            <div class="container container--flex">
                   <h3 class="group__title">Editar Plato</h3>
            </div>
        </section>
        <div class="container">
            <h5>
                Usted podrá Registrar, Modificar y Eliminar precio producto
            </h5>
            <h5>
                (*) Campos obligatorios
            </h5>
            <br>
            <form action="php/editar_precio.php" method="post" enctype="multipart/form-data">
               <input type="hidden" name="id_plato" value="<?php echo $id_plato; ?>">
                <label class="lista" for="">Nombre: </label>
                <input class="input" type="text" name="nombre">                
                <br>
                <br>
                <label class="lista" for="">Categoría: </label>
                <input class="input" type="text" name="id_categoria">    
                <br>
                <br>
                ...
                <br>
                <br>
                <label class="lista" for="">Precio: </label>
                <input class="input" type="text" name="precio">         
                <br>
                <br>
                <label class="lista" for="">Imagen: </label>
                <input type="file" required name="imagen" class="img-chiqui">
                <br>
