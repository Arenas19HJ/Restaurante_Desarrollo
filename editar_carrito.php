...
<body>
   ...
   <nav class="main-nav">
    ...
    <main class="main">
        <section class="group">
            <div class="container container--flex">
                   <h3 class="group__title">Editar Plato seleccionado</h3>
            </div>
        </section>
        <div class="container">
            <form action="php/editarcarrito.php" method="post">
               <input type="hidden" name="id_plato" value="<?php echo $id_plato; ?>">
                <label class="lista" for="">Cantidad: </label>
                <input class="input" type="text" name="cantidad">    
                <br>
                <input type="submit" value="Volver" class="btn2" style="margin: 10px 40px 10px 10px" target="_blank">>
            </form>
        </div>
    </main>      
