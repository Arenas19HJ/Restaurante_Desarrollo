...
<body>
   ...
   <nav class="main-nav">
    ...
    <main class="main">
        ...
        <section class="group">
            <div class="container container--flex">
                   <h3 class="group__title">Registrar promocion</h3>
            </div>
        </section>
        <div class="container">
            <h5>
            ...
            <br>
            <form action="php/registrarPromocion.php" method="post" enctype="multipart/form-data">
                ...
                <input type="file" class="input" required name="imagen" class="img-chiqui">
                <br>
