<?php
include("php/cn.php");
$entregas ="SELECT id_pedido, repartidor, fecha FROM entregas";
?>
   ...
   <nav class="main-nav">
       <div class="container container--flex">
           ...
           <ul class="menu" id="menu">
               ...
               <li class="menu__item"><a href="entregas.php" class="menu__link menu__link--select">Lista de entregas</a></li>
    ...
    <main class="main">
        <section class="group">
            <div class="container container--flex">
                   <h3 class="group__title">Lista de Entregas</h3>
            </div>
        </section>
    </main>  
    <div class="container container--flex">
       <div class="column column--51">
        <a href="listaEntregas.html" class="btn btn--contact">Registrar</a>
        </div>
    </div>
            <div class="container container--flex registro__platos">        
                  <div class="column column--25">
                   <h3 class="column__title">N° pedido</h3>
                   </div>
                  <div class="column column--25"> 
                   <h3 class="column__title">Repartidor</h3>
                   </div>
                   <div class="column column--25">  
                   <h3 class="column__title">Fecha</h3>
                   </div>     
            </div>
<?php $resultado = mysqli_query($conexion, $entregas);
...
while($row = mysqli_fetch_assoc($resultado)){?>            
            <div class="container container--flex registro__platos">        
                  <span class="container container--flex registro__platos slec" id="btnOpciones2">
                       ...
                       <div class="column column--25"> 
                       <p class="column__txt"><?php echo $row ["fecha"];?></p>
                       </div>
                   </span>
            </div> 
<?php }?> 
