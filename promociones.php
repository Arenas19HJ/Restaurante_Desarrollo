<?php
include("php/cn.php");
$promocion ="SELECT * FROM promociones";
?>
...
<nav class="main-nav">
    ...
    <main class="main">
        <section class="group">
            <div class="container container--flex">
                   <h3 class="group__title">Promociones</h3>
            </div>
        </section>
        <section class="group">
            <div class="container">
       ...
       <div class="column column--51">
        <a href="registrar_promocion.php" class="btn btn--contact">Registrar</a>
        </div>
           </div>
            ...
            <div class="container container--flex registro__platos" enctype="multipart/form-data">        
                  <div class="column column--16">
                   <h3 class="column__title">id Prom</h3>
                   </div>
                   <div class="column column--16"> 
...
<?php 
$resultado = mysqli_query($conexion, $promocion);
while($row = mysqli_fetch_assoc($resultado)){?>            
             <div class="container container--flex registro__platos">        
                  <span class="container container--flex registro__platos slec" id="btnOpciones2">
                       <div class="column column--16">
                       <p class="column__txt"><?php echo $row ["id_promocion"];?></p>
                       </div>
                       <div class="column column--16">
                      ...
                      <div class="column column--16"> 
                       ...
                       <div class="column column--16"> 
                       <a href="agregar_Prom.php?id_promocion=<?php echo $row["id_promocion"]; ?>" class="social-icon__link"><span class="icon-modi" ></span></a> 
                       <a href="ver_Prom.php?id_promocion=<?php echo $row["id_promocion"]; ?>" class="social-icon__link"><span class="icon-search" ></span></a>
                       <a href="php/eliminar_promocion.php?id_promocion=<?php echo $row["id_promocion"]; ?>" class="social-icon__link"><span class="icon-delete" ></span></a> 
                       </div>
                   </span>
            </div> 
<?php }?>
